    ...
    return (
        < div className="max-w-sm rounded overflow-hidden shadow-lg" >
            ...
            >
                ...
                < img
                    className="w-full duration-500 hover:scale-105 hover:shadow-xl"
            ...
            <div className="px-6 py-4">
                {tags.map((tag, index) => (
                    <button
                        ...
                        className="inline-block bg-green-400 rounded-3xl px-3 py-1 text-sm font-semibold text-white m-2 duration-500 hover:scale-105 hover:shadow-xl"
                    >
                        #{tag}
                    </button>
                ))}
